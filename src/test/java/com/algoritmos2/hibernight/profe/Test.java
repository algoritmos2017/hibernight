...
public class Test extends DataBaseConfig 
{
	...
	@org.junit.Test
	public void testXQL() throws IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchMethodException, ClassNotFoundException, SQLException
	{
		Connection con = getConnection();
